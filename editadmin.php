                ...
                <div class="card-body">
                  <form method="POST" action="update_admin.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ID_USER" placeholder="masukan nama" value="<?= $d['ID_USER']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="alamat">USERNAME</label>
                      <input type="text" class="form-control" name="USERNAME" placeholder="masukan nama" value="<?= $d['USERNAME']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="alamat">PASWORD</label>
                      <input type="text" class="form-control" name="PASWORD" placeholder="masukan nama" value="<?= $d['PASWORD']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="alamat">TELP</label>
                      <input type="text" class="form-control" name="TELP" placeholder="masukan nama" value="<?= $d['TELP']; ?>">
                    </div>
